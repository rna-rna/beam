...
export const SendGridTemplates = {
  ...
  magicLinkInvite: process.env.SENDGRID_MAGIC_LINK_TEMPLATE_ID || process.env.SENDGRID_INVITE_TEMPLATE_ID, // Fallback to invite template if magic link template not set
};
