  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto px-4 py-12">
        <h1 className="font-geist-sans text-4xl font-bold mb-8">About Image Gallery Hub</h1>
        
        <h2 className="font-geist-sans text-2xl font-semibold mb-4 mt-8">Our Mission</h2>
        ...
        <h2 className="font-geist-sans text-2xl font-semibold mb-4 mt-8">Features</h2>
        <p className="font-geist-mono text-sm leading-relaxed mb-6">
        ...
        <h2 className="font-geist-sans text-2xl font-semibold mb-4 mt-8">Technology</h2>
        <p className="font-geist-mono text-sm leading-relaxed mb-6">
        ...
        <h2 className="font-geist-sans text-2xl font-semibold mb-4 mt-8">Contact</h2>
